...
# publish.single(topic, json.dumps(current_state_message), hostname=mqtt_host,port=1883, auth={'username':username, 'password':password})
...
publish.single(topic, json.dumps(change_state_message), hostname=mqtt_host, auth={
